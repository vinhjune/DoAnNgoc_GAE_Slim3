...
<body class="home">
			...
			<div id="login-form" class="login-mod">
				...
				<div class="login-wrap">
					<form action="dangNhap" method="post">
						<input type="text" name="username" value="username/email address"
							id="username" autocomplete="off" onclick="this.value='';" /> <input
							type="password" name="password" value="" id="password" /> <input
							type="hidden" name="redirect_url" value="/" id="redirect_url" />
						<input type="hidden" name="defaultUsernameValue"
							value="username/email address" id="defaultUsernameValue" /> <input
							class="login-btn" type="submit" value="Đăng nhập" />
					</form>
				</div>
			</div>
			<!-- #login-form -->
 ...
 %> <a href="#" title="Login to My World" id="header_login_link">Đăng
							nhập</a> <%
 	}
 %>
					</li>
				...
				<ul id="main-nav">
					<li><a href="index" title="Home">Trang chủ<span
							class="tab"></span></a></li>
					...
					%>
					<li class="item53"><a href="addDiaDiem"> <span>Thêm
								địa điểm</span></a></li>
					<li class="item53"><a href="addTour"><span>Thêm
								tour Tour</span></a></li>
					<%
						}
					%>
					<%
						if (loggedin.equals("true")) {
					%>
					<li><a href="/manageBooking" title="My bookings">Giao dịch
							của tôi<span class="tab"></span>
					</a></li>
					<%
						}
					%>
							...
							<div class="search-strip">
								<form name="tourSearch" action="timTour" id="tour-search-form">
										...
										<li class="roundback bigdropdownright">
											<div>
												<input type="text" id="ngayXP" name="ngayXP"
													style="width: 180px" value="Ngày khởi hành"
													onclick="this.value='';" /> <img src="images/cal.gif"
										...
										<li class="roundback bigdropdownleft">
											<div>
												<input type="text" id="thoiGian" name="thoiGian"
													style="width: 200px" value="Thời gian (Ngày)"
													onclick="this.value='';" />
											</div>
										</li>
									</ul>
									<ul style="margin-top: 5px;">
										...
										<li class="roundback bigdropdownright">
											<div>
												<input type="text" id="gia" name="gia" style="width: 200px"
													value="Giá (VNĐ)" onclick="this.value='';" />
											</div>
										</li>
						...
						<div id="tours">
							...
							<div class="pageright" style="margin-left: 0; float: left;">
								...
								<div class="best-selling">
									<h2
										style="margin-left: 10px; margin-top: 0px; text-align: center">Giới
										thiệu về chúng tôi</h2>
											...
											<li>
												...
												<div style="" class="right">
													<div style="padding: 10px">
														<p>PTIT Tour là ứng dụng xây dựng dựa trên Google App
															Engine và framework Slim3.</p>
														<p>PTIT Tour được phát triển phục vụ cho đồ án tốt
															nghiệp đại học</p>
														<p>Chuyên ngành Công Nghệ Phần Mềm</p> 
														<p>Khoa Công Nghệ Thông Tin</p>
														<p>Học viện Công Nghệ Bưu Chính Viễn Thông</p>
														<p>PTIT Tour được phát triển bởi <b>Cao Bảo Ngọc</b>, sinh viên lớp D08CNPM3.
														<p style="text-align: right">Tháng 12/2012.</p>
													</div>
												</div>
											</li>
										</ul>
...
$(document).ready(function(){
	...
	<script type="text/javascript" src="/javascripts/tours_deployed.js"></script>
