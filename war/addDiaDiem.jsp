...
<div class="panel-region-separator"></div>			</div>
				...
				<h2 style="margin-left: 10px; margin-top: 0px;text-align: center">Thêm địa điểm mới</h2>
				<div class="greybox rounded" style="padding:10px; width:600px;">
	<ul>
						    		    		<li>
			<div style="" class="right">
			<p style="color: red; text-align: center">${error }</p>
      				<form method="post" action="createDiaDiem">
      				<table cellpadding="10" cellspacing="10" border-spacing="-1" width="100%" style="border-collapse:separate;border-spacing: 2px;">
      				<tr><td>
						<tr><td style="width: 10%;">Tên địa điểm: </td><td><input type="text" id="name" name="name"/></td></tr>
						<tr><td colspan="2"><textarea rows="10" cols="50" id="moTa" name="moTa"></textarea>
						</td></tr>
						<tr><td colspan="2"> <ul class="searchbutton">
				<li id="muabutton" style="margin-left:200px">
				<div>
				<button id="find-hostels-btn" tabindex="15" rel="no-follow" type="button" title="Them tour" onclick="submit(this.form)">Thêm địa điểm</button>
				</div>
				</li>
				</ul></td></tr>
						</table>
