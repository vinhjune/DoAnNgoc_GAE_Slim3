...
<div class="panel-region-separator"></div>			</div>
	...
	<ul>
			...
			<div style="" class="right">
      				<form method="post" action="dangKyUser">
      				<p style="color: red; text-align: center" >${error}</p>
      				<table cellpadding="10" cellspacing="10" border-spacing="-1" width="100%" style="border-collapse:separate;border-spacing: 20px;">
      				<tr><td></td><td>
		<select id="type" name="type">
			<option></option>
			<option value="khach">Khach du lich</option>
			<option value="congTy">Cong ty du lich</option>
		</select> </td></tr>
		<tr><td>
		Tài khoản: </td><td><input type="text" id="username" name="username"/></td></tr>
		<tr><td>Mật khẩu: </td><td><input type="password" id="password" name="password"/></td></tr>
		<tr><td>Họ tên: </td><td><input type="text" id="hoTen" name="hoTen"/></td></tr>
		<tr><td>Ngày sinh: </td><td><input type="text" id="ngaySinh" name="ngaySinh"/>
		<img src="images/cal.gif" onclick="javascript:NewCssCal('ngaySinh','yyyyMMdd','dropdown',false,'24','','past')" style="cursor:pointer"/>
		</td></tr>
		<tr><td>Email: </td><td><input type="email" id="email" name="email"/></td></tr>
		<tr><td>Điện thoại: </td><td><input type="text" id="phone" name="phone"/></td></tr>
		<tr><td>Địa chỉ: </td><td><input type="text" id="diaChi" name="diaChi"/></td></tr>
		<tr><td colspan="2"><input type="submit" value="Dang ky"/></td></tr>
		</table>
	</form>		
			</div>
