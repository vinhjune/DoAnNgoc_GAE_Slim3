...
<div class="pageright" id="onecol_right">
	<h2 style="text-align: center; font-size: 22pt">Các tour sắp khởi hành</h2>
	<!-- 
	   			...
	   			<li>
					...
					<div style="" class="right">
						...
						<div class="featuretourbox white rounded">
							<h3>
								<a class="tourName" style="color: #FC411C" title="${f:h(t.ten)}" href="viewTour?tourKey=${f:h(t.key)}">${f:h(t.ten)}</a>
							</h3>
							<span class="ngay rounded"><fmt:formatDate value="${t.ngayXP}" pattern="dd-MM-yyyy" /></span>
							<ul>
								<span class="gia rounded">${f:h(t.gia)} VNĐ</span>
								<li><span><a href="#">${f:h(t.ddXP)}</a></span> >> <span><a href="#">${f:h(t.ddDich)}</a></span></li>
								...
								<br/>
								<li><a style="float:none; font-style:italic; color:#FC411C" title="More info" class="more" href="viewTour?tourKey=${f:h(t.key)}">More info</a></li>
