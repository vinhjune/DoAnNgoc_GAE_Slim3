...
<body class="home">
 ...
 %>
						...
						<div id="tours">
							...
							<div class="pageright" style="margin-left: 0; float: left;">
								...
								<div class="best-selling">
									<h2 style="margin-left: 10px; margin-top: 0px;text-align: center">Đăng nhập</h2>
	...
	<table cellpadding="10" cellspacing="10" border-spacing="-1" width="100%" style="border-collapse:separate;border-spacing: 20px;">
      				<tr><td>
		Tài khoản: </td><td><input type="text" id="username" name="username"/></td>
		<tr><td>
		Mật khẩu:</td><td> <input type="password" id="password" name="password"/></td></tr>
		<tr><td colspan="2">
		<input type="submit" value="Đăng nhập"/></td></tr></table>
	</form>
								</div>
